    ...
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 px-4 sm:px-4">
      <div class="flex-1 text-start lg:text-left">
        ...
        <h2 class="text-2xl sm:text-4xl font-bold mb-6 leading-tight text-white">
          Las Escuelas Invierten a Ciegas
        </h2>
        <p class="text-md sm:text-md text-gray-300/80 leading-relaxed max-w-2xl my-6">
          Se gastan millones en tecnología educativa (hardware, software, kits) que no se hablan
          entre sí. Los directores compran equipos costosos sin currículo pedagógico y los docentes
          no están capacitados.
        </p>
        <span class="font-bold text-white text-lg">Resultado: Alto costo y cero impacto real.</span>
        <div class="flex flex-col mt-4 gap-8">
          ...
          >
            ...
            Inversión sin retorno educativo
          </span>
        </div>
      </div>
