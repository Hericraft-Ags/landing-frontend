<template>
  <section id="educacion50" class="py-24 px-6 bg-white" aria-labelledby="educacion50-title">
    <div class="max-w-6xl mx-auto text-center">
      <span
        class="text-green-600 font-bold uppercase tracking-widest text-sm mb-2 block"
        role="text"
      >
