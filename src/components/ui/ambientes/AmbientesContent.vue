...
<script setup>
import AmbientesFeatureList from '@/components/ui/ambientes/AmbientesFeatureList.vue'
import AmbientesActions from '@/components/ui/ambientes/AmbientesActions.vue'
